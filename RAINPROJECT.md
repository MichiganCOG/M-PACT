...
|:------------------------:|:----------------------------------: |:------------------------------------------: |:-------------------------------:|:-------------------------------:|:------------------------------:|:------------------------------:|:----------------------------------------------------------:|:-----------------------:|
|   VGG16 + LSTM           |              --.--%                 |                  --.--%                     |             --.--%              |             --.--%              |             --.--%             |             --.--%             |                              -.-                           |            -.-          |          
| ResNet50 + LSTM          |              43.01%                 |                  41.33%                     |           **41.38%**            |           **41.49%**            |           **41.35%**           |             41.11%             |                            0.0321                          |          0.0826         |          
...
|:-----------------------------------:|:----------------------------: |:---------------: |:-------------: |:--------------------------------: |:-------------------------------:|:-------------------------------:|:------------------------------:|:------------------------------:|:---------------------:|:-----------------------:|
| ResNet50 + RAINv35.lstm + LSTM      |              42.22%           |        -.--      |      -.--      |                --.--%             |             --.--%              |             --.--%              |             --.--%             |             --.--%             |           -.-         |           -.-           |
| ResNet50 + RAINv36.lstm + LSTM      |            **44.51**%         |        -.--      |      -.--      |                --.--%             |             --.--%              |             --.--%              |             --.--%             |             --.--%             |           -.-         |           -.-           |
| ResNet50 + RAINv37.lstm + LSTM      |            **44.31**%         |        -.--      |      -.--      |                --.--%             |             --.--%              |             --.--%              |             --.--%             |             --.--%             |           -.-         |           -.-           |
...
| ResNet50 + RAINv23.2.1 + LSTM       |             **46.01**%        |        0.50      |      N/A       |            **44.41**%             |           **44.44%**            |             44.09%              |           **44.87%**           |             44.25%             |         0.0337        |          0.0861         |
| ResNet50 + RAINv23.4 + LSTM         |             **45.62**%        |        1.0       |      N/A       |            **44.29**%             |             44.17%              |             43.70%              |           **45.18%**           |             44.10%             |         0.0294        |          0.0762         |
| ResNet50 + RAINv23.7.1 + LSTM       |             **44.77**%        |        0.83      |      N/A       |            **43.33**%             |           **44.30%**            |           **43.47%**            |           **43.49%**           |             42.05%             |         0.0366        |          0.0929         |
| | | | |
...
| ResNet50 + RAINv31.3 + LSTM         |             **44.25**%        |        N/A       |      0.97      |            **42.82**%             |             41.36%              |             42.32%              |           **44.82%**           |             42.79%             |         0.0388        |          0.0985         |
| ResNet50 + RAINv34.3.lstm + LSTM    |             **44.71**%        |        N/A       |    > 0.94      |            **42.89**%             |             40.86%              |             42.37%              |           **44.32%**           |           **43.99%**           |         0.0389        |          0.103          |
