...
|       Experiments        | Mean Recog. Accuracy(MRA) on Orig.  | Mean Recog. Accuracy(MRA) on Rate Modified  | Rate Bin 1 Accuracy (Slow Down) | Rate Bin 2 Accuracy (Slow Down) | Rate Bin 3 Accuracy (Speed Up) | Rate Bin 4 Accuracy (Speed Up) |
|:------------------------:|:----------------------------------: |:------------------------------------------: |:-------------------------------:|:-------------------------------:|:------------------------------:|:------------------------------:|
|   VGG16 + LSTM           |              --.--%                 |                  --.--%                     |             --.--%              |             --.--%              |             --.--%             |             --.--%             |
| ResNet50 + LSTM          |              43.01%                 |                  41.33%                     |           **41.38%**            |           **41.49%**            |           **41.35%**           |             41.11%             |
...
| ResNet50 + RAINv23.4 + LSTM         |             **45.62**%        |        1.0       |      N/A       |            **44.29**%             |             44.17%              |             43.70%              |           **45.18%**           |             44.10%             |
| ResNet50 + RAINv23.7.1 + LSTM       |             **44.77**%        |        0.83      |      N/A       |            **43.33**%             |           **44.30%**            |           **43.47%**            |           **43.49%**           |             42.05%             |
| | | | |
