...
|:-----------------------------------:|:----------------------------: |:---------------: |:-------------: |:--------------------------------: |:-------------------------------:|:-------------------------------:|:------------------------------:|:------------------------------:|:---------------------:|:-----------------------:|
| ResNet50 + RAINv35.lstm + LSTM      |              41.44%           |        0.5       |    > 0.86      |                --.--%             |             --.--%              |             --.--%              |             --.--%             |             --.--%             |           -.-         |           -.-           |
| ResNet50 + RAINv36.lstm + LSTM      |              38.37%           |        0.19      |    > 0.98      |                --.--%             |             --.--%              |             --.--%              |             --.--%             |             --.--%             |           -.-         |           -.-           |
| ResNet50 + RAINv37.lstm + LSTM      |              42.42%           |        0.96      |    > 0.985     |                --.--%             |             --.--%              |             --.--%              |             --.--%             |             --.--%             |           -.-         |           -.-           |
| ResNet50 + RAINv38 + LSTM           |            **44.25**%         |        0.80      |      0.86      |              **42.89**%           |           **43.09**%            |           **42.97**%            |           **43.64**%           |             41.87%             |          3.73%        |           9.75%         |
| ResNet50 + RAINv39 + LSTM           |              41.83%           |        1.0       |      0.54      |                --.--%             |             --.--%              |             --.--%              |             --.--%             |             --.--%             |           -.-         |           -.-           |
| ResNet50 + RAINv40 + LSTM           |              41.83%           |        0.64      |      0.77      |                --.--%             |             --.--%              |             --.--%              |             --.--%             |             --.--%             |           -.-         |           -.-           |
| | | | |
