" I3D CVR MODEL WITH FROZEN BATCH-NORM WEIGHTS IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
from i3d_cvr_preprocessing_TFRecords    import preprocess           as preprocess_tfrecords
...
class I3D_CVR():
    ...
    def __init__(self, cvr, input_alpha=1.0, verbose=True):
        """
        Args:
            :cvr:         Value of alpha to resample inputs to network (associated with training a model)
