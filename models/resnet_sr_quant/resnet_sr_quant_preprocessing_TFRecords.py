...
def model_resample_sinusoidal(video, sample_dims, frame_count, tracker, num_vids, num_epochs, batch_size, num_clips, num_gpus):
...
def preprocess(input_data_tensor, frames, height, width, channel, input_dims, output_dims, seq_length, size, label,cvr, input_alpha, istraining, num_vids, num_epochs, batch_size, num_clips, num_gpus, tracker):
	"""
	...
	if istraining:
		...
		input_data_tensor, alpha_tensor = model_resample_sinusoidal(input_data_tensor, sample_dims, footprint, tracker, num_vids, num_epochs, batch_size, num_clips, num_gpus)
	else:
