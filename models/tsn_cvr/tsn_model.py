...
class TSN_CVR():
    def __init__(self, input_dims, output_dims, exp_name, num_seg=3, init=False, cvr=0.8, input_alpha=1.0, verbose=True):
        self.name        = 'tsn_cvr'
    ...
    def inference(self, inputs, is_training, input_dims, output_dims, seq_length, scope, dropout_rate = 0.8, return_layer=['logits'], weight_decay=0.0005):
        ...
        with tf.name_scope(scope, 'tsn_cvr', [inputs]):
            layers = {}
