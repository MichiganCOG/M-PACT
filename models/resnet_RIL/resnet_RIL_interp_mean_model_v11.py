" RESNET-50 + RAIN (INTERP + MEAN) v11 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Mean_v11():
    ...
    def __init__(self, verbose=True):
        ...
        self.name = 'resnet_RIL_interp_median_model_v11'
        print "resnet RIL interp median v11 initialized"
    ...
    def _extraction_layer(self, inputs, params, sets, K, L):
        ...
        sample_phi_tick   = tf.reduce_mean(params[:,0])
    ...
    def inference(self, inputs, is_training, input_dims, output_dims, seq_length, scope, k, j, dropout_rate = 0.5, return_layer='logits', data_dict=None, weight_decay=0.0):
        ...
        if self.verbose:
            print('Generating RESNET RAIN INTERP MEDIAN v11 network layers')
