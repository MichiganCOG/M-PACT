" RESNET-50 + RAIN (INTERP + MEDIAN) v14_3 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Median_v14_3():
    ...
    def __init__(self, verbose=True):
        ...
        self.name = 'resnet_RIL_interp_median_model_v14_3'
        print "resnet RIL interp median v14_3 initialized"
    ...
    def inference(self, inputs, is_training, input_dims, output_dims, seq_length, scope, k, j, dropout_rate = 0.5, return_layer='logits', data_dict=None, weight_decay=0.0):
        ...
        if self.verbose:
            print('Generating RESNET RAIN INTERP MEDIAN v14_3 network layers')
        ...
        with tf.name_scope(scope, 'resnet', [inputs]):
            ...
            layers['FC1'] = fully_connected_layer(input_tensor=layers['Reshape2'],
                    out_dim=512, non_linear_fn=None,
