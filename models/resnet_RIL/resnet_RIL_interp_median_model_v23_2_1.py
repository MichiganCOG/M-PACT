" RESNET-50 + RAIN (INTERP + MEDIAN) v23_2_1 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Median_v23_2_1():
    ...
    def __init__(self, input_dims, k, verbose=True):
        ...
        self.j          = input_dims / k
        self.name       = 'resnet_RIL_interp_median_model_v23_2_1'

        print "resnet RIL interp median v23_2_1 initialized"
    ...
    def inference(self, inputs, is_training, input_dims, output_dims, seq_length, scope, dropout_rate = 0.5, return_layer=['logits'], weight_decay=0.0):
        ...
        if self.verbose:
            print('Generating RESNET RAIN INTERP MEDIAN v23_2_1 network layers')
