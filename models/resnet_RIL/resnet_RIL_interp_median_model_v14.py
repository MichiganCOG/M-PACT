" RESNET-50 + RAIN (INTERP + MEDIAN) v14 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Median_v14():
    ...
    def __init__(self, verbose=True):
        ...
        self.name = 'resnet_RIL_interp_median_model_v14'
        print "resnet RIL interp median v14 initialized"
