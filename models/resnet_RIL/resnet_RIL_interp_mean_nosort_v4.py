" RESNET-50 + RAIN (INTERP + MEAN + NOSORT) v4 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Mean_Nosort_v4():
    ...
    def __init__(self, verbose=True):
        ...
        self.name = 'resnet_RIL_interp_mean_nosort_v4'
        print "resnet RIL interp mean nosort v4 initialized"
    ...
    def _extraction_layer(self, inputs, params, sets, K, L):
        ...
        # Index estimates
        output_idx = tf.reduce_mean(params, axis=0)
