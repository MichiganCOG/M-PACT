" RESNET-50 + RAIN (INTERP MEAN) v1 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Mean_v1():
    ...
    def __init__(self, verbose=True):
        ...
        self.name = 'resnet_RIL_interp_mean_model_v1'
        print "resnet RIL interp  mean v1 initialized"
    ...
    def inference(self, inputs, is_training, input_dims, output_dims, seq_length, scope, k, j, dropout_rate = 0.5, return_layer='logits', data_dict=None, weight_decay=0.0):
        ...
        if self.verbose:
            print('Generating RESNET RAIN INTERP MEAN v1 network layers')
