" RESNET-50 + RAIN (INTERP + MEDIAN + LSTM) v31_3 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Median_v31_3_lstm():
    ...
    def __init__(self, verbose=True):
        ...
        self.name = 'resnet_RIL_interp_median_model_v31_3_lstm'
        print "resnet RIL interp median v31_3_lstm initialized"
