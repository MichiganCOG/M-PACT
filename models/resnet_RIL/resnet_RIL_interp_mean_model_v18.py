" RESNET-50 + RAIN (INTERP + MEAN) v18 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Mean_v18():
    ...
    def __init__(self, verbose=True):
        ...
        self.name = 'resnet_RIL_interp_mean_model_v18'
    ...
    def _extraction_layer(self, inputs, params, sets, K, L):
        ...
        sample_alpha_tick = tf.tanh(tf.reduce_mean(params[:,0]))
        sample_phi_tick   = tf.tanh(tf.reduce_mean(params[:,1]))
