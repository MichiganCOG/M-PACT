" RESNET-50 + RAIN (INTERP + MEDIAN + LSTM) v36 + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Median_v36_lstm():
    ...
    def __init__(self, verbose=True):
        ...
        print "resnet RIL interp median v36_lstm initialized"
	...
	# Create y0 and y1 outputs
        ...
        output = tf.reshape(output, (L, shp_h, shp_w, channel), name='RIlayeroutput1')
