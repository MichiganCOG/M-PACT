" RESNET-50 + RAIN (INTERP + MEDIAN + LSTM) v36_LSTM + LSTM MODEL IMPLEMENTATION FOR USE WITH TENSORFLOW "
...
class ResNet_RIL_Interp_Median_v36_lstm():
    ...
    def __init__(self, verbose=True):
        ...
        self.name = 'resnet_RIL_interp_median_model_v36_lstm'
        print "resnet RAIN interp median v36_lstm initialized"
